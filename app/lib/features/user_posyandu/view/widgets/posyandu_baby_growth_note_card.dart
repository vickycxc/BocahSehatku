...
import 'package:app/features/user_posyandu/view/pages/posyandu_baby_growth_history_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class PosyanduBabyGrowthNoteCard extends StatelessWidget {
  final AnakModel anak;
  const PosyanduBabyGrowthNoteCard(this.anak, {super.key});
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PosyanduBabyGrowthHistoryPage(),
                  ),
                );
              },
